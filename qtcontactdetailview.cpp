                    ...
                    contactForm(new QtContactForm())
{
    ...
    contactForm->fbIdField->setReadOnly(true);
    contactForm->instaField->setReadOnly(true);
...
void QtContactDetailView::displayContact(Contact::ContactId id)
{
    ...
    else
    {
        ...
        contactForm->fbIdField->setText(c.fbId.c_str());
        contactForm->instaField->setText(c.insta.c_str());
    }
